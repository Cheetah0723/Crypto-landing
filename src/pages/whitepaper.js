    ...
    <div className="whitepaper">
      <div className="paper-content">
        ...
        <div className="paper-title">
          <h2>
            Part of the Expanding Aetherverse<span>TM</span>
          </h2>
          <img src={divider} />
          <p>
            Mythik<span>TM</span> is made by Aetherverse<span>TM</span>Studios.
          </p>
          <p>We believe NFTs are the future of computer and tabletop gaming.</p>
          <p>Help us build the future together!</p>
          <Button className="paper-button">Read our White Paper</Button>
          <a href="#">
            <p>Join Discord</p>
          </a>
          <img src={divider2} />
