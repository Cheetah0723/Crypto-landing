    ...
    <div className="inventory">
      <div className="roadmap">
        ...
        <div className="roadmap-content">
          ...
          <img src={divider} />
          <p>
            We are working hard to make Mythik<span>TM</span> the best
            experience possible.
          </p>
          <p>
            Read an indepth explanation of our <a href="#">roadmap here.</a>
          </p>
      ...
      <div className="contact-social">
        <div className="socials">
          ...
          <p>
            @2022 Aetherverse<span>TM</span> Studios. All rights reserved.
          </p>
        </div>
      </div>
    </div>
